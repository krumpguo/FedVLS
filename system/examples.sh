...
#nohup python -u main.py -lbs 64 -nc 25 -ncp 5 -jr 1 -nb 10 -data Digit5 -m mobilenetv2 -algo FedAvg -gr 100 -did 0 -lr 0.01 -ls 10 -ed 1e-4 > digit5_fedavg.out 2>&1 &

#nohup python -u main.py -lbs 64 -nc 30 -ncp 5 -jr 1 -nb 345 -data DomainNet -m mobilenetv2 -algo FedAvg -gr 100 -did 0 -lr 0.01 -ls 10 -ed 1e-4 > domainnet_fedavg.out 2>&1 &
